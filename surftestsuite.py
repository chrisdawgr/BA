...
def surf_tester(pic1, pic2):
  p1 = harris.harris(pic1, 0.04, 340000000, 1)
  p2 = harris.harris(pic2, 0.04, 340000000, 1)
  ...
  #(sp1, sp2,_ ,_ ) = h.oneNN(desc1, desc2, po1, po2)
...
surf_tester("marklil1.jpg", "marklil2.jpg")
