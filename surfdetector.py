...
def findSurfPoints(filename):
  ...
  for y in range(3,I_bw.shape[0]-3):
    for x in range(3,I_bw.shape[1]-3):
      ...
      o1[1, y,x] = conv15[0,y,x]*conv15[1,y,x]-((0.9*conv15[2,y,x])**2)
      o1[2, y,x] = conv21[0,y,x]*conv21[1,y,x]-((0.9*conv21[2,y,x])**2)
      o1[3, y,x] = conv27[0,y,x]*conv27[1,y,x]-((0.9*conv27[2,y,x])**2)

      o2[0, y,x] = conv15[0,y,x]* conv9[1,y,x]-((0.9*conv9[2,y,x])**2)
      o2[1, y,x] = conv27[0,y,x]*conv15[1,y,x]-((0.9*conv15[2,y,x])**2)
      o2[2, y,x] = conv39[0,y,x]*conv21[1,y,x]-((0.9*conv21[2,y,x])**2)
      o2[3, y,x] = conv51[0,y,x]*conv27[1,y,x]-((0.9*conv27[2,y,x])**2)

      o3[0, y,x] = conv27[0,y,x]* conv9[1,y,x]-((0.9*conv9[2,y,x])**2)
      o3[1, y,x] = conv51[0,y,x]*conv15[1,y,x]-((0.9*conv15[2,y,x])**2)
      o3[2, y,x] = conv75[0,y,x]*conv21[1,y,x]-((0.9*conv21[2,y,x])**2)
      o3[3, y,x] = conv99[0,y,x]*conv27[1,y,x]-((0.9*conv27[2,y,x])**2)
